    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (specifier === "@langchain/langgraph-checkpoint") {
            ...
            if (!langgraphPackageURL) {
                const main = yield nextResolve("@langchain/langgraph", Object.assign(Object.assign({}, context), { parentURL }));
                langgraphPackageURL = main.url.toString();
            }
            return yield nextResolve(specifier, Object.assign(Object.assign({}, context), { parentURL: langgraphPackageURL }));
        }
        if (OVERRIDE_RESOLVE.some((regex) => regex.test(specifier))) {
            const resolved = yield nextResolve(specifier, Object.assign(Object.assign({}, context), { parentURL }));
